...
const dailyKeyboard = () => new InlineKeyboard().text('صفقة واحدة', 'set:daily:1').text('صفقتان', 'set:daily:2').row().text('3 صفقات', 'set:daily:3').text('4 صفقات', 'set:daily:4').row().text('رجوع', 'cfg:allocation');
